...
_ID: QA01_`;
    ...
    if (ui.alive === 1) return pika.reply(caption.trim());
        ...
        buttons: [
            ...
            {
                "name": "cta_url",
                "buttonParamsJson": "{\"display_text\":\"WhatsApp Channel 🔮\",\"url\":\"https://chat.whatsapp.com/Eij7WbOgTcY3V44xFKRIZ8\",\"merchant_url\":\"https://www.google.com\"}"
            },
            {
                "name": "cta_url",
                "buttonParamsJson": "{\"display_text\":\"YouTube Channel 💗\",\"url\":\"https://youtube.com/@uncountableaura\",\"merchant_url\":\"https://www.google.com\"}"
            },
...
const cateData = {
  "core": {
    "desc": "Essᴇɴᴛɪᴀʟ ᴄᴏᴍᴍᴀɴᴅs ғᴏʀ ᴛʜᴇ ʙᴏᴛ",
    "emoji": "💻"
  },
  "admins": {
    "desc": "Cᴏᴍᴍᴀɴᴅs ᴇxᴄʟᴜsɪᴠᴇʟʏ ғᴏʀ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴs",
    "emoji": "🍜"
  },
  "ai": {
    "desc": "Sᴘᴇᴄɪᴀʟ ᴄᴏᴍᴍᴀɴᴅs ᴘᴏᴡᴇʀᴇᴅ ʙʏ AI",
    "emoji": "🫂"
  },
  "anime": {
    "desc": "Dɪsᴄᴏᴠᴇʀ ᴀɴɪᴍᴇ—ʙᴇᴄᴀᴜsᴇ Mʏ 𝗔𝗻𝗶𝗿𝗯𝗮𝗻 Lᴏᴠᴇ Iᴛ !",
    "emoji": "☺️"
  },
  "convert": {
    "desc": "Tʀᴀɴsғᴏʀᴍ ᴍᴇᴅɪᴀ ɪɴᴛᴏ ᴅɪғғᴇʀᴇɴᴛ ғᴏʀᴍᴀᴛs",
    "emoji": "🧧"
  },
  "download": {
    "desc": "Dᴏᴡɴʟᴏᴀᴅ ᴄᴏɴᴛᴇɴᴛ ғʀᴏᴍ ᴠᴀʀɪᴏᴜs ᴘʟᴀᴛғᴏʀᴍs",
    "emoji": "🧩"
  },
  "general": {
    "desc": "Gᴇɴᴇʀᴀʟ ᴄᴏᴍᴍᴀɴᴅs ғᴏʀ ᴇᴠᴇʀʏᴏɴᴇ",
    "emoji": "🍁"
  },
  "textpro": {
    "desc": "Cʀᴇᴀᴛᴇ sᴛʏʟɪsʜ ᴛᴇxᴛ ɪᴍᴀɢᴇs",
    "emoji": "❤️‍🔥"
  },
  "logomaker": {
    "desc": "Cʀᴀғᴛ ᴇʏᴇ-ᴄᴀᴛᴄʜɪɴɢ ʟᴏɢᴏs",
    "emoji": "🌟"
  },
  "photooxy": {
    "desc": "Dᴇsɪɢɴ sᴛʏʟɪsʜ ʙᴀɴɴᴇʀs ᴡɪᴛʜ ᴛᴇxᴛ",
    "emoji": "🎀"
  },
  "nsfw": {
    "desc": "Cᴏᴍᴍᴀɴᴅs ᴄᴏɴᴛᴀɪɴɪɴɢ ᴇxᴘʟɪᴄɪᴛ ᴄᴏɴᴛᴇɴᴛ",
    "emoji": "🐤"
  },
  "owner": {
    "desc": "Cᴜsᴛᴏᴍɪᴢᴀᴛɪᴏɴ ᴀɴᴅ sᴇᴛᴛɪɴɢs ғᴏʀ Mʏ Aɴɪʀʙᴀɴ...... I ᴍᴇᴀɴ ᴍʏ ᴏᴡɴᴇʀ",
    "emoji": "😅"
  },
  "religious": {
    "desc": "Cᴏᴍᴍᴀɴᴅs ʀᴇʟᴀᴛᴇᴅ ᴛᴏ ʀᴇʟɪɢɪᴏɴ",
    "emoji": "🛐"
  },
  "search": {
    "desc": "Sᴇᴀʀᴄʜ ᴛʜᴇ ɪɴᴛᴇʀɴᴇᴛ ᴡɪᴛʜ ᴇᴀsᴇ",
    "emoji": "💖"
  },
  "stalker": {
    "desc": "Aᴄᴄᴇss ᴠᴀʀɪᴏᴜs ᴛʏᴘᴇs ᴏғ ɪɴғᴏʀᴍᴀᴛɪᴏɴ",
    "emoji": "🍂"
  },
  "tools": {
    "desc": "Uᴛɪʟɪᴛʏ ᴛᴏᴏʟs ғᴏʀ ᴠᴀʀɪᴏᴜs ᴘᴜʀᴘᴏsᴇs",
    "emoji": "🔮"
  },
  "fun": {
    "desc": "Cᴏᴍᴍᴀɴᴅs ғᴏʀ ɢʀᴏᴜᴘ ғᴜɴ ᴘᴜʀᴘᴏsᴇ",
    "emoji": "💃🏻"
  },
  "games": {
    "desc": "Vᴀʀɪᴏᴜs ᴅɪɢɪᴛᴀʟ ɢᴀᴍᴇs Pᴏᴡᴇʀᴇᴅ Bʏ Aɴɪʀʙᴀɴ-Sᴀɴ",
    "emoji": "🎲"
  },
  "imagemaker": {
    "desc": "Iᴍᴀɢᴇ ᴇᴅɪᴛɪɴɢ ᴘʀᴇsᴇᴛs ᴘʟᴜɢɪɴs",
    "emoji": "🌄"
  }
};
...
> *\`🌟 Rᴇᴘʟʏ A Nᴜᴍʙᴇʀ Tᴏ Gᴇᴛ Cᴏᴍᴍᴀɴᴅ Lɪsᴛ\`*\n\n`;
